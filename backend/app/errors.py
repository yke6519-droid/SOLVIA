...
class ErrorCode(str, Enum):
    ...
    CHAT_FACT_TOOL_REQUIRED = "CHAT_FACT_TOOL_REQUIRED"
    ...
    STATION_COORDINATES_MISSING = "STATION_COORDINATES_MISSING"
    ...
    IMPORT_PREVIEW_MISMATCH = "IMPORT_PREVIEW_MISMATCH"
    ...
    FILE_ARTIFACT_INVALID = "FILE_ARTIFACT_INVALID"
    FILE_ARTIFACT_NOT_FOUND = "FILE_ARTIFACT_NOT_FOUND"
    FILE_ARTIFACT_FORBIDDEN = "FILE_ARTIFACT_FORBIDDEN"
    FILE_ARTIFACT_EXPIRED = "FILE_ARTIFACT_EXPIRED"
    DB_UNAVAILABLE = "DB_UNAVAILABLE"
    UPSTREAM_ERROR = "UPSTREAM_ERROR"
    WEATHER_API_INVALID_RESPONSE = "WEATHER_API_INVALID_RESPONSE"
    UPSTREAM_TIMEOUT = "UPSTREAM_TIMEOUT"
    RUNTIME_TOOL_EXECUTION_FAILED = "RUNTIME_TOOL_EXECUTION_FAILED"
